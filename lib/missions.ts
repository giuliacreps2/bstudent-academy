    ...
    missions: [
      {
        ...
        maxErrors: 2,
        objectives: [
          "Riconoscere i casi principali in una frase",
          "Distinguere soggetto e complemento oggetto",
        ],
      ...
      },
      {
        ...
        maxErrors: 2,
        objectives: [
          "Declinare un nome femminile della prima declinazione",
          "Riconoscere il genitivo e il dativo",
        ],
        coverImageUrl: "/placeholder-exercise.png",
      ...
      },
      {
        ...
        objectives: [
          "Riconoscere la struttura dell'ablativo assoluto",
          "Tradurlo correttamente in italiano",
        ],
        coverImageUrl: "/placeholder-exercise.png",
      ...
      },
      {
        ...
        maxErrors: 2,
        objectives: [
          "Riconoscere le proposizioni con cum + congiuntivo",
          "Distinguere cum narrativo, causale e concessivo",
        ],
        coverImageUrl: "/placeholder-exercise.png",
      ...
      },
      {
        ...
        maxErrors: 3,
        objectives: [
          "Mettere in pratica grammatica e traduzione insieme",
          "Affrontare un testo autentico senza aiuti",
        ],
        coverImageUrl: "/placeholder-exercise.png",
