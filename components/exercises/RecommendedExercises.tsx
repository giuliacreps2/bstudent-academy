// components/exercises/RecommendedExercises.tsx
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        {isLoading
          ? [0, 1, 2].map((i) => (
              ...
              >
                <div className="w-full h-24 bg-surface-blue" />
                <div className="p-3 space-y-2">
                  <div className="h-3 w-16 bg-surface-blue rounded-pill" />
                  <div className="h-4 w-full bg-surface-blue rounded" />
                  <div className="h-8 w-full bg-surface-blue rounded-pill mt-1" />
                </div>
              </div>
            ))
